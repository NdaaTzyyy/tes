...
const {
	default: makeWASocket,
	 AnyMessageContent, delay, DisconnectReason, fetchLatestBaileysVersion, getAggregateVotesInPollMessage, makeCacheableSignalKeyStore, makeInMemoryStore, PHONENUMBER_MCC, proto, useMultiFileAuthState, WAMessageContent, WAMessageKey } = (await import('@whiskeysockets/baileys')).default
...
const startSock = async() => {
	...
	sock.ev.on('connection.update', async (update) => {
        ...
        if (update.connection == "open" || update.receivedPendingNotifications == "true") {
            console.log(`Connected to = ` + JSON.stringify(shock.user, null, 2))
        }
    })
